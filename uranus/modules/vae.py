...
class VideoVAE_(nn.Module):
    ...
    def clear_cache(self):
        # Flash-VAED decoder (vae_flash.HybridDecoder3d) exposes its own cache
        # slot count (includes CausalDepthwiseConv3d); fall back to the legacy
        # count for the original Decoder3d.
        count_fn = getattr(self.decoder, "count_conv3d", None) or count_conv3d
        self._conv_num = count_fn(self.decoder)
        self._conv_idx = [0]
